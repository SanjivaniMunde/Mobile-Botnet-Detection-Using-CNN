...
lbl = tk.Label(root, text="Mobile Botnet using CNN", font=('times', 35,' bold '), height=1, width=32,bg="violet Red",fg="Black")
lbl.place(x=300, y=10)
# _+++++++++++++++++++++++++++++++++++++++++++++++++++++++

def Model_Training():
    start = time.time()
    data = pd.read_csv("D:/botnet_mobile/botnet_mobile/new1.csv")
    data.head()
...
button4 = tk.Button(root, foreground="white", background="black", font=("Tempus Sans ITC", 14, "bold"),
                    text="Detect Mobile Botnet", command=call_file, width=15, height=2)
