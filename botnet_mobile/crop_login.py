...
bg1_icon=ImageTk.PhotoImage(file="D:\\pyhon program\\30%-Module-mobile botnet\\m.jpg")

bg_icon=ImageTk.PhotoImage(file="D:\\pyhon program\\30%-Module-mobile botnet\\L.jpg")
user_icon=ImageTk.PhotoImage(file="D:\\pyhon program\\30%-Module-mobile botnet\\l1.png")
pass_icon=ImageTk.PhotoImage(file="D:\\pyhon program\\30%-Module-mobile botnet\\p1.jpg")
...
button1 = tk.Button(label_l1, text="HOME", command=log, width=12, height=1,font=('times 15 bold underline'),bd=0, bg="brown", fg="white")
button1.place(x=1190, y=50)

button2 = tk.Button(label_l1, text="REGISTER",command=con,width=12, height=1,font=('times 15 bold underline'), bd=0,bg="brown", fg="white")
