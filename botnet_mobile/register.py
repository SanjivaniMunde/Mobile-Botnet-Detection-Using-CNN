...
#
label_l1 = tk.Label(root, text="__Mobile Botnet Detection System___",font=("Times New Roman", 30, 'bold'),
...
l1 = tk.Label(frame_alpr, text="__Registration Form__", font=("Times new roman", 30, "bold","italic"),bd=5, bg="#8B1C62", fg="white")
l1.place(x=120, y=10)
...
button1 = tk.Button(label_l1, text="HOME", command=con, width=12, height=1,font=('times 15 bold underline'),bd=0, bg="brown", fg="white")
button1.place(x=1190, y=50)

button2 = tk.Button(label_l1, text="LOGIN",command=log,width=12, height=1,font=('times 15 bold underline'), bd=0,bg="brown", fg="white")
button2.place(x=1310, y=50)

button4 = tk.Button(label_l1, text="EXIT", command=window, width=12, height=1,font=('times 15 bold underline'),bd=0,bg="brown", fg="white")
...
label_l1 = tk.Label(root, text="** Mobile Botnet Detection System @ 2021 by _____ **",font=("Times New Roman", 10, 'bold'),
